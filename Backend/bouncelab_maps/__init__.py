...
def _default_maps():
    ...
    return [
        level("첫 번째 바운스", "SYSTEM",
              [(x, 2) for x in range(1, 5)] + [(x, 4) for x in range(5, 9)] +
              [(x, 6) for x in range(2, 7)] + [(x, 8) for x in range(6, 9)] +
              [(x, 10) for x in range(2, 6)] + [(x, 12) for x in range(5, 9)],
              [(4, 1), (5, 1)], (2, 1), (7, 13)),
        level("갈림길", "SYSTEM",
              [(2, 2), (3, 2), (6, 2), (7, 2), (4, 4), (5, 4),
               (2, 6), (3, 6), (6, 6), (7, 6), (4, 8), (5, 8),
               (2, 10), (3, 10), (6, 10), (7, 10), (4, 12), (5, 12)],
              [(4, 1), (5, 1), (4, 6), (5, 10)], (2, 1), (5, 13), [(7, 2)]),
        level("스프링 타워", "SYSTEM",
              [(2, 2), (3, 2), (6, 5), (7, 5), (2, 8), (3, 8), (6, 11), (7, 11)],
              [(4, 1), (5, 1), (8, 5)], (2, 1), (7, 12), [(3, 2), (7, 5), (3, 8)]),
    ]
